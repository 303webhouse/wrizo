...
await withHarness(async (app) => {
  ...
  await sleep(100);
  await app.evalJs("(() => { const __t = document.querySelector('[data-box-id=\"fx5-s4-a\"] .board-layer-toggle'); if (!__t) throw new Error(\"no click target: document.querySelector('[data-box-id=\\\"fx5-s4-a\\\"] .board-layer-toggle')\"); return __t.click(); })()");
  await sleep(100);
  ...
  await app.evalJs("(() => { const __t = document.querySelector('.wz-sliver-grip'); if (!__t) throw new Error(\"no click target: document.querySelector('.wz-sliver-grip')\"); return __t.click(); })()"); // close
