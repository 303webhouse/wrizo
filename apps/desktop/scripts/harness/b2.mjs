...
await withHarness(async (app) => {
  ...
  await app.evalJs("(() => { const __t = document.querySelector('.board-dest-row'); if (!__t) throw new Error(\"no click target: document.querySelector('.board-dest-row')\"); return __t.click(); })()");
  await sleep(200);
  ...
  await app.evalJs("(() => { const __t = document.querySelector('.btn-quiet'); if (!__t) throw new Error(\"no click target: document.querySelector('.btn-quiet')\"); return __t.click(); })()");
  ...
  await app.evalJs("(() => { const __t = [...document.querySelectorAll('.board-dest-row')].find(el => el.textContent.includes('S5 existing page')); if (!__t) throw new Error(\"no click target: [...document.querySelectorAll('.board-dest-row')].find(el => el.textContent.includes('S5 existing pa...\"); return __t.click(); })()");
  await sleep(300);
